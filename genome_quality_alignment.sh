...
# Now let's have a look on the reads quality using FastQC and seqkit
...
# There several alignment tools available. For example, minimap2, BWA, Bowtie, etc. Here we will use BWA for this purpose: https://github.com/lh3/bwa
...
# Now you can filter for secondary and supplemnentary alignments if needed
...
# This will give you insights into how well the genome is covered by the reads, which is another important metric for assessing genome quality.
